	  ...
	  @Test
	   ...
	   public void findLoansTest() throws Exception {
		  //cenario
		   ...
		   BDDMockito.given( loanService.find(Mockito.any(LoanFilterDTO.class), (org.springframework.data.domain.Pageable) Mockito.any(Pageable.class)) )
          .willReturn( new PageImpl<Loan>( Arrays.asList(loan), PageRequest.of(0,100), 1 )   );
		   ...
		   .get(LOAN_API.concat(queryString)).accept(MediaType.APPLICATION_JSON);
